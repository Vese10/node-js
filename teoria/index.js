...
/* Come funzionano le richieste HTTP:
      Come funziona il web? 
         Abbiamo la parte CLIENT (utente, browser) ---> facciamo delle richieste http --> server (node/express)
         E la parte SERVER (node/express) ---> abbiamo la risposta http --> client (utente, browser)
         Il client interagisce facendo delle richiesta tramite la parte front-end dello sviluppo web ed ottiene delle risposte dal server, che è la parte back-end dello sviluppo web ed è il posto dove sono immagazzinati i dati.
